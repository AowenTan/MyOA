...
<div id="Menu">
    <ul id="MenuUl">
        ...
        <li class="level1">
            ...
            <ul style="display: none;" class="MenuLevel2">
                <li class="level2">
                    <div class="level2Style"><img src="style/images/MenuIcon/menu_arrow_single.gif" /> <a target="_blank" href="http://www.yueqian.com.cn/">公司网站</a></div>
                </li>
                <li class="level2">
                    <div class="level2Style"><img src="style/images/MenuIcon/menu_arrow_single.gif" /> <a target="_blank" href="http://12306.com">火车时刻</a></div>
                </li>
                <li class="level2">
