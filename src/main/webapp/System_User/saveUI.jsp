    ...
    <script type="text/javascript">
    	$(function(){
    		$("#loginName").blur(function(){
    			var name=$(this).val();
    			$.post("../user/checkName.do",{"name":name},function(date){
    				alert(date);
    			});
    		});
    		$("#sub").click(function(){
...
<!--显示表单内容-->
<div id=MainArea>
    <form id="fom" action="../user/register.do" method="post">
                        ...
                        <td><select name="did" class="SelectStyle">
                                <option value="0" selected="selected">请选择部门</option>
                              	<c:forEach items="${deptList }" var="dept">
                              		<option value="${dept.getDid() }">${dept.dname }</option>
                              	</c:forEach>
                            </select> 
                        </td>
                    </tr>
                    <tr><td>登录名</td>
                        <td><input id="loginName" type="text" name="loginName" class="InputStyle"/> *
							（登录名要唯一）
						</td>
                    </tr>
                    <tr><td>姓名</td>
        ...
        <div id="InputDetailBar">
            <input id="sub" type="image" src="../style/images/save.png"/>
